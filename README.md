...
Riverbraid-Integration-Gold is a canonical Gold module surface within Riverbraid.

This repository represents the Integration domain inside the current Evaluation Kit registry. It supports integration boundary review across Riverbraid surfaces while Riverbraid-Core remains the normative source for protocol semantics.
